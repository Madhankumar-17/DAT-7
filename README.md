
{
  ...
  "metadata": {
    "colab": {
      "provenance": [],
      "mount_file_id": "1beMK2Y6yeAIoVbOCaQvEnwsX44VQmBbM",
      "authorship_tag": "ABX9TyMoUxIX1VgSWXIP8fKX65nM",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/Madhankumar-17/DAT-7/blob/main/DAY%207.ipynb\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "markdown",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "6p_yaVAYZyHn",
        "outputId": "860e5bff-7390-4361-ad37-156ef531f5b6"
      },
      "outputs": [
        {
          "output_type": "stream",
          "name": "stdout",
          "text": [
            "Loaded spam.csv from Google Drive.\n",
            "Dataset Head:\n"
          ]
        },
        {
          ...
          "data": {
            ...
            "text/html": [
              "\n",
              "  <div id=\"df-f2b43e94-b1c9-4f5d-ac51-ccced3893974\" class=\"colab-df-container\">\n",
              "    <div>\n",
              "<style scoped>\n",
              ...
              "    <button class=\"colab-df-convert\" onclick=\"convertToInteractive('df-f2b43e94-b1c9-4f5d-ac51-ccced3893974')\"\n",
              ...
              "    <script>\n",
              "      const buttonEl =\n",
              "        document.querySelector('#df-f2b43e94-b1c9-4f5d-ac51-ccced3893974 button.colab-df-convert');\n",
              "      buttonEl.style.display =\n",
              "        google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "      async function convertToInteractive(key) {\n",
              "        const element = document.querySelector('#df-f2b43e94-b1c9-4f5d-ac51-ccced3893974');\n",
              "        const dataTable =\n",
      ...
      "source": [
        ...
        "# Load the dataset\n",
        "try:\n",
        "    # Attempt to load the spam.csv file\n",
        "    df = pd.read_csv('/content/drive/MyDrive/smart_traffic_management_dataset.csv', encoding='latin-1')\n",
        "    print(\"Loaded spam.csv from Google Drive.\")\n",
        "except FileNotFoundError:\n",
        "    # If spam.csv is not found, use the dummy DataFrame\n",
        "    print(\"Error: spam.csv not found in Google Drive. Using a dummy DataFrame for demonstration purposes.\")\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "h104OJLmZ_68",
        "outputId": "e02bdcb3-b122-4fd1-b24d-68dc0a0f7eac"
      },
      "execution_count": 41,
      "outputs": [
        {
        ...
        },
        {
          ...
          "data": {
            ...
            "text/html": [
              "\n",
              "  <div id=\"df-cae98440-b9fc-469c-b79d-92e713bc127b\" class=\"colab-df-container\">\n",
              "    <div>\n",
              "<style scoped>\n",
              "    .dataframe tbody tr th:only-of-type {\n",
              "        vertical-align: middle;\n",
              ...
              "      <th>4</th>\n",
              "      <td>0</td>\n",
              "      <td>Nah I dont think he goes to usf, he only walks...</td>\n",
              "    </tr>\n",
              "  </tbody>\n",
              "</table>\n",
              "</div>\n",
              ...
              "\n",
              "  <div class=\"colab-df-container\">\n",
              "    <button class=\"colab-df-convert\" onclick=\"convertToInteractive('df-cae98440-b9fc-469c-b79d-92e713bc127b')\"\n",
              "            title=\"Convert this dataframe to an interactive table.\"\n",
              "            style=\"display:none;\">\n",
              "\n",
              "  <svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\" viewBox=\"0 -960 960 960\">\n",
              ...
              "    <script>\n",
              "      const buttonEl =\n",
              "        document.querySelector('#df-cae98440-b9fc-469c-b79d-92e713bc127b button.colab-df-convert');\n",
              "      buttonEl.style.display =\n",
              "        google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "      async function convertToInteractive(key) {\n",
              "        const element = document.querySelector('#df-cae98440-b9fc-469c-b79d-92e713bc127b');\n",
              "        const dataTable =\n",
              "          await google.colab.kernel.invokeFunction('convertToInteractive',\n",
              "                                                    [key], {});\n",
              "        if (!dataTable) return;\n",
            ...
            "application/vnd.google.colaboratory.intrinsic+json": {
              "type": "dataframe",
              "summary": "{\n  \"name\": \"display(df['label']\",\n  \"rows\": 5,\n  \"fields\": [\n    {\n      \"column\": \"label\",\n      \"properties\": {\n        \"dtype\": \"number\",\n        \"std\": 0,\n        \"min\": 0,\n        \"max\": 1,\n        \"num_unique_values\": 2,\n        \"samples\": [\n          1,\n          0\n        ],\n        \"semantic_type\": \"\",\n        \"description\": \"\"\n      }\n    },\n    {\n      \"column\": \"text\",\n      \"properties\": {\n        \"dtype\": \"string\",\n        \"num_unique_values\": 5,\n        \"samples\": [\n          \"Free entry in 2 a wkly comp to win FA Cup finals tkts 21st May 2005.\",\n          \"Nah I dont think he goes to usf, he only walks around here.\"\n        ],\n        \"semantic_type\": \"\",\n        \"description\": \"\"\n      }\n    }\n  ]\n}"
            }
          },
          "metadata": {}
        },
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "eUCo3BxBaMR8",
        "outputId": "0a24b02e-9d85-4e65-dfd4-1e5d4aa34d5e"
      },
      "execution_count": 42,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "31XsmbsKaTpU",
        "outputId": "b82e9e64-7b59-44f2-da29-2c1b25136814"
      },
      "execution_count": 43,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "M56ThLj0aaST",
        "outputId": "ef884d0a-8cdc-49e1-99b2-5e04403a04a7"
      },
      "execution_count": 44,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "20a2097e",
        "outputId": "4533bf09-3271-45bb-f512-a3520f54e081"
      },
      "source": [
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "735e58b7",
        "outputId": "3f690ae9-1051-410f-c1e0-9ee0bc764ad3"
      },
      "source": [
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "15bf8fed",
        "outputId": "8030ef42-749b-4868-c549-a4e6dc0767fb"
      },
      "source": [
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "b9d0a95a",
        "outputId": "c40b270d-76fe-4c5f-cf32-0ca3ae85ccfe"
      },
      "source": [
        "import pandas as pd\n",
        "\n",
      ...
      "outputs": [
        ...
        },
        {
          ...
          "data": {
            ...
            "text/html": [
              "\n",
              "  <div id=\"df-008b5d77-84e3-41ef-84d5-3aebd3e69502\" class=\"colab-df-container\">\n",
              "    <div>\n",
              "<style scoped>\n",
              "    .dataframe tbody tr th:only-of-type {\n",
              "        vertical-align: middle;\n",
              ...
              "\n",
              "  <div class=\"colab-df-container\">\n",
              "    <button class=\"colab-df-convert\" onclick=\"convertToInteractive('df-008b5d77-84e3-41ef-84d5-3aebd3e69502')\"\n",
              "            title=\"Convert this dataframe to an interactive table.\"\n",
              "            style=\"display:none;\">\n",
              "\n",
              "  <svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\" viewBox=\"0 -960 960 960\">\n",
              ...
              "    <script>\n",
              "      const buttonEl =\n",
              "        document.querySelector('#df-008b5d77-84e3-41ef-84d5-3aebd3e69502 button.colab-df-convert');\n",
              "      buttonEl.style.display =\n",
              "        google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "      async function convertToInteractive(key) {\n",
              "        const element = document.querySelector('#df-008b5d77-84e3-41ef-84d5-3aebd3e69502');\n",
              "        const dataTable =\n",
              "          await google.colab.kernel.invokeFunction('convertToInteractive',\n",
              "                                                    [key], {});\n",
              "        if (!dataTable) return;\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "64e84ecf",
        "outputId": "e37c28f2-371e-4278-80ba-3c78e2a6b9f4"
      },
      "source": [
        ...
        "\n",
        "# Handle missing values based on available columns in dummy data\n",
        "# For the dummy data, 'genre', 'rating', 'year' are the relevant columns\n",
        "movie_df.dropna(subset=['genre', 'rating', 'year'], inplace=True)\n",
        "\n",
        "# Encode 'genre' column to numerical labels\n",
        "le = LabelEncoder()\n",
        "movie_df['genre_encoded'] = le.fit_transform(movie_df['genre'])\n",
        "\n",
        "# 'year' column is already numeric, rename for consistency if desired, or use directly\n",
        "movie_df['release_year'] = movie_df['year']\n",
        "\n",
        "# Define features (X) and target (y) using available and processed columns\n",
        "X_movie = movie_df[['rating', 'release_year']]\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "5aaa091a",
        "outputId": "4d54f15e-4d78-4d64-81db-92ee1eed4580"
      },
      "source": [
        "# Define the model\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "3a1abf62",
        "outputId": "672d944e-b3ed-47e7-9595-c102cc8adfe5"
      },
      "source": [
